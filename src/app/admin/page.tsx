    ...
    <div className="mx-auto max-w-xl space-y-6">
      <div>
        ...
        <p className="mt-2 text-[var(--muted)]">
          Sync the PGA schedule and create a league tournament. To change settings later, use{" "}
          <strong>Edit</strong> next to Draft and Scoreboard on the tournament.
        </p>
      </div>
        ...
        <label className="block space-y-1 text-sm">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              const selected = cached.find((t) => t.id === e.target.value);
              if (selected) setName(selected.name);
            }}
          >
            <option value="">Select a cached tournament</option>
            {cached.map((t) => (
      ...
      {leagueTournaments.length > 0 && (
        <section className="space-y-3 border border-[var(--line)] bg-[var(--panel)]/80 p-5">
          <h2 className="font-semibold">Edit existing</h2>
          <p className="text-sm text-[var(--muted)]">
            Open a tournament&apos;s Edit page (also linked next to Draft / Scoreboard).
          </p>
            ...
            {leagueTournaments.map((t) => (
              ...
              >
                ...
                <Link
                  ...
                  className="border border-[var(--line)] px-3 py-1 hover:bg-[var(--accent-soft)]"
                >
                  Edit
                </Link>
              </li>
